...
The response will include stages titled `Executable code` and `Executable code result` for the code generated by the model and the result of its execution.
