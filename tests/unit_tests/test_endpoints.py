...
test_cases: List[TestCase] = [
    ...
    TestCase(D.GEMINI_2_5_PRO, True, True, False),
    TestCase(D.GEMINI_2_0_PRO_EXP_02_05, True, True, False),
    TestCase(D.GEMINI_2_5_PRO_EXP_03_25, True, True, False),
    TestCase(D.GEMINI_2_5_PRO_PREVIEW_03_25, True, True, False),
    TestCase(D.GEMINI_2_0_FLASH_LITE_1, True, True, False),
    TestCase(D.GEMINI_2_5_FLASH, True, True, False),
    TestCase(D.GEMINI_2_5_FLASH_PREVIEW_04_17, True, True, False),
