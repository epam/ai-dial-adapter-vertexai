...
from aidial_adapter_vertexai.utils.protobuf import message_to_str
...
class VertexAIChat:
    ...
    async def _predict_streaming(
        ...
        async for chunk in response:
            if log.isEnabledFor(logging.DEBUG):
                log.debug(f"predict response chunk:\n{message_to_str(chunk)}")
